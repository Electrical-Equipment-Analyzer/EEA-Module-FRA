...
@ActionID(
        category = "Analyzer",
        id = "tw.edu.sju.ee.eea.module.fra.file.fr.action.FrDiffIEEEAction"
)
@ActionRegistration(
        displayName = "#CTL_FrDiffIEEEAction"
)
@ActionReferences({
    @ActionReference(path = "Menu/Analyzers/Frequency Response Analysis", position = 120)
})
@Messages("CTL_FrDiffIEEEAction=IEEE")
public final class FrDiffIEEEAction implements ActionListener {

    private final List<FrDataObject> context;

    public FrDiffIEEEAction(List<FrDataObject> context) {
